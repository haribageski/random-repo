...
public class InputListTest {
	...
	public void testGetAllRows() throws IOException 
	{
		...
		InputStream inStream = MapFactory.class.getClassLoader().getResourceAsStream("airports.csv");
	...
	{
		InputStream inStream = MapFactory.class.getClassLoader().getResourceAsStream("wrong_filename");
